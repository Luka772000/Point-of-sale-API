    ...
    public partial class UpdatedUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZaglavljaRacuna", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ZaglavljaRacuna_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ZaglavljaRacuna_Kupci_KupacId",
                        column: x => x.KupacId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StavkeRacuna_ZaglavljaRacuna_ZaglavljeRacunaId",
                        column: x => x.ZaglavljeRacunaId,
                        principalTable: "ZaglavljaRacuna",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ZaglavljaRacuna_Broj",
                table: "ZaglavljaRacuna",
                column: "Broj",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ZaglavljaRacuna_KupacId",
                table: "ZaglavljaRacuna",
                column: "KupacId");

            migrationBuilder.CreateIndex(
                name: "IX_ZaglavljaRacuna_UserId",
                table: "ZaglavljaRacuna",
                column: "UserId");
        }
